...
<svg viewBox="0 0 720 190" width="100%" role="img" aria-label="LLM calls filesystem tools (read_file, write_file, edit_file, delete, ls, grep, glob) which pass through a Backend to storage." xmlns="http://www.w3.org/2000/svg" font-family="'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif">
  ...
  <text x="244" y="64" text-anchor="middle" font-size="11" fill="#99D3FF" font-family="'IBM Plex Mono', ui-monospace, monospace">read_file · write_file · edit_file · delete</text>
...
<svg viewBox="0 0 720 190" width="100%" role="img" aria-label="LLM calls filesystem tools plus execute, which go to a Sandbox, an isolated environment." xmlns="http://www.w3.org/2000/svg" font-family="'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif">
  ...
  <text x="246" y="64" text-anchor="middle" font-size="11" fill="#99D3FF" font-family="'IBM Plex Mono', ui-monospace, monospace">read_file · write_file · edit_file · delete</text>
