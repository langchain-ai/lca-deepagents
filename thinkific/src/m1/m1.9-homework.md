...
<div style="text-align:center;margin:2.5rem 0 2.5rem;">
  <p style="font-size:2rem;font-weight:700;margin-bottom:0.5rem;">Congratulations on finishing Module 1!</p>
  ...
  ><img src="images/langchain-symbol.png" style="height:1.1em;vertical-align:middle;margin-right:8px;filter:brightness(0) invert(1);opacity:0.9"> Wahoo!</button>
</div>
