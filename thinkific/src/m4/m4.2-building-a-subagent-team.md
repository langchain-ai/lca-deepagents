...
<div style="background:#FFFBEB;border:1px solid #FCD34D;border-radius:6px;padding:10px 14px;margin:12px 0;color:#92400E;font-size:14px;line-height:1.5;"><strong>&#9888; Troubleshooting:</strong> <code>FilesystemPermission</code> rules are evaluated in order, first match wins. If you write a broad deny rule before a subagent's own scratch-folder allow rule, the deny will match first and silently lock that subagent out of its own scratch path. Always list the narrower allow rule first, then the broader deny.</div>
