...
**[View this run here in LangSmith.](https://smith.langchain.com/public/ecaa227f-3971-4096-a8ff-7626cb2adb7d/r)** Notice the parallel subagent calls, and the use of the `write_todos` tool: planning is opt-in via <span data-lang="python"><code>TodoListMiddleware</code></span><span data-lang="typescript"><code>todoListMiddleware</code></span>, so add it to your agent's `middleware` list if you want to see the same thing in your own trace.
