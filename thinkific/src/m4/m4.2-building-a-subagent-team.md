...
The lab built one "editor" main agent that delegated to a single `genre-researcher` subagent type, once per music genre. This homework asks you to build your own small team of 2-3 subagent types for a domain of your choosing (not a newsletter, not music genres). There's no single correct team here: two people doing this homework could end up with completely different subagents and completely different delegation instructions.
