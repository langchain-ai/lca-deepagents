...
WHAT YOU FILL IN
  TODO 1: define 2-3 subagent dicts (name, description, system_prompt, and
...
#
# Requirements:
#   - 2 to 3 subagents, each a plain dict with at least "name",
...
#           "system_prompt": "You are ... Your job is to ...",
#           "model": model,
#       },
#       ...
#   ]
...
def build_subagent_team() -> list[dict]:
    """TODO 1: return a list of 2-3 subagent dicts for your own domain."""
...
USER_REQUEST = "TODO 2: replace this with a request that should trigger delegation to your team."
